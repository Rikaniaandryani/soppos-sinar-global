					...
					<tbody>
						<?php $no = 1; foreach ($category as $category): ?>
							<tr>
								<td><?php echo $no;?></td>
								<!-- <td>
									<img src="<?php echo base_url($path_file.'/'.$thumb_pre.$category->image_name);?>" class="img img-responsive" alt="<?php echo $category->category_alt;?>">
								</td> -->
								...
								<td>
									...
									<?php if ($category->category_pub == '88'): ?>
										<a href="<?php echo site_url('admin/category/action/publish?id='.hash_link_encode($category->category_id));?>" class="btn btn-flat btn-danger" title="Publish">
											<i class="fa fa-bullhorn"></i>
										</a>
									<?php else: ?>
										<a href="<?php echo site_url('admin/category/action/publish?id='.hash_link_encode($category->category_id));?>" class="btn btn-flat btn-success" title="Publish">
											<i class="fa fa-bullhorn"></i>
										</a>
									<?php endif ?>
									<a class="btn btn-flat btn-default btn-edit-category" data-id="<?php echo hash_link_encode($category->category_id);?>" title="Update">
										<i class="fa fa-edit"></i>
									</a>
									<a onclick="return confirm('Are you sure ?')"  href="<?php echo site_url('admin/category/action/delete?id='.hash_link_encode($category->category_id));?>" class="btn btn-warning btn-flat" title="Delete">
...
<div id="add" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			...
			<?php echo form_open_multipart('admin/category/action/insert');?>
...
<div id="update" class="modal fade" role="dialog">
	<div class="modal-dialog modal-lg">
		...
		<div class="modal-content">
			...
			<?php echo form_open_multipart('admin/category/action/update');?>
			<div class="modal-body">
				<div class="form-group">
					<label for="category">Category Name</label>
